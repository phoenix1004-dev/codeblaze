            ...
            <div className="ssr-variant hidden-r5chz7 hidden-wbkh13 !contents">
              <div className="framer-vtwi8j-container">
                ...
                >
                  ...
                  >
                    <div
                      className="framer-aylbmo flex flex-col justify-start shrink-0 transform translate-x-[-50%] text-blue-500 no-underline text-opacity-50 !bottom-[-145px]"
                      data-framer-component-type="RichTextContainer"
                    >
                      ...
                      <p className="framer-text text-left !text-[#9b9b9b] text-[15px] font-mono leading-[1.4em]">
                        <span className="framer-text !text-[#9b9b9b]">
                          3 &lt;meta{" "}
                        </span>
                        charset="UTF-8"&gt;
                      </p>
                    ...
                    <div
                      className="framer-1oukmxi border border-solid border-gray-800 bg-gray-900"
                      data-border="true"
                      data-framer-name="Top bar"
                    >
                      <div
                        className="framer-11sdx13 border border-solid border-gray-800 bg-gray-900 rounded-[10px]"
                        data-border="true"
                      ...
                      >
                        ...
                        ></div>
                        <div
                          className="framer-rbznzg rounded-[5px]"
                          data-framer-name="HTML"
                        >
                          <div
                            className="framer-kys8oo outline-none flex flex-col justify-start flex-shrink-0 text-white hover:text-blue-500 underline"
                            data-framer-component-type="RichTextContainer"
                          >
                        ...
                        <div
                          className="framer-xkb282 rounded-[5px]"
                          data-framer-name="React"
                          data-highlight="true"
                          tabIndex={0}
                        >
                          <div
                            className="framer-kp2roy outline-none flex flex-col justify-start flex-shrink-0 text-blue-500 no-underline"
                            data-framer-component-type="RichTextContainer"
                          >
                            <h4
                    ...
                    <div
                      className="framer-1l8m52c border border-solid border-gray-800 bg-gray-900 rounded-[2px] shadow-[0px_0px_2px_0.5px_rgba(112,190,250,0.75)]"
                      data-border="true"
