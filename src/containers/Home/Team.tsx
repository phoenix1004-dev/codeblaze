    ...
    >
      ...
      <div className="ssr-variant hidden-5tblbe">
            ...
            <div className="framer-99rgx0-container">
              <section className="flex w-full h-full max-w-full max-h-full place-items-center m-0 p-[5px] list-none indent-0 opacity-100 mask-image-[linear-gradient(to_right,_rgba(0,_0,_0,_0)_0%,_rgba(0,_0,_0,_1)_12.5%,_rgba(0,_0,_0,_1)_87.5%,_rgba(0,_0,_0,_0)_100%)] overflow-hidden">
                <ul className="flex w-full h-full max-w-full max-h-full place-items-center m-0 p-0 list-none indent-0 gap-[25px] relative flex-row will-change-transform translate-x-[-0px]">
                        ...
                        >
                          ...
                          <div className="framer-uwwp7h">
                            ...
                            >
                              <img
                                decoding="async"
                                src="https://framerusercontent.com/images/NS0MjC73BwIBZdXwTNCgKOj2H4.png"
                                alt="Memoji Dave Jones"
                                className="block w-full h-full rounded-inherit object-center object-cover"
                              />
                            </div>
                          </div>
                        </div>
                        <div className="framer-wcisl7" data-framer-name="Text">
                          <div
                          ...
                          <div
                            className="framer-1fzkqxd flex flex-col justify-start shrink-0 text-blue-500 underline"
                            data-framer-component-type="RichTextContainer"
                          >
                            <h3
                  ...
                  <li className="w-[350px]">
                    <div
                      className="framer-1lkxvr2-container w-[350px] flex-shrink-0"
                      data-framer-cursor="1s3n1vh"
                    >
                      <div
                        className="framer-PCfLc framer-NrkXy framer-1psfxqf framer-v-16etmem border border-solid border-[1px] border-[rgb(34,34,34)] rounded-[10px] shadow-[0px_0px_2px_0.5px_rgba(112,190,250,0)] h-full w-full"
                        style={{
                          background:
                            "radial-gradient(50% 50% at 0% 0%, rgba(80, 176, 250, 0.1) 0%, rgba(64, 140, 199, 0.05) 36.486486486486484%, var(--token-dfa0f935-df64-49a6-bd04-21d89df786a9, rgb(13, 13, 13)) 100%)",
                        }}
                        data-border="true"
                        data-framer-name="Team Emily Branson"
                        data-highlight="true"
                        tabIndex={0}
                      >
                        <div
                          className="framer-wkdxqg border border-solid border-[1px] border-[rgb(34,34,34)] 
       rounded-[10px]"
                          data-border="true"
                          data-framer-name="Memoji"
                        >
                          ...
                          <div className="framer-uwwp7h">
                            ...
                            >
                              <img
                                decoding="async"
                                src="https://framerusercontent.com/images/FZRNEebJYtUrPM9BKNr88wiqqQc.png"
                                alt="Memoji Emily Branson"
                                className="block w-full h-full rounded-inherit object-center object-cover"
                              />
                            </div>
                          </div>
                  ...
                  <li className="w-[350px]">
                    <div
                      className="framer-1pd33ya-container w-[350px] flex-shrink-0"
                      data-framer-cursor="18etrss"
                    >
                      <div
                        className="framer-PCfLc framer-NrkXy framer-1psfxqf framer-v-fz27om border border-solid border-[1px] border-[rgb(34,34,34)] 
       bg-gradient-radial from-[rgba(80,176,250,0.1)] 
       via-[rgba(64,140,199,0.05)] to-[rgb(13,13,13)] 
       rounded-[10px] shadow-[0px_0px_2px_0.5px_rgba(112,190,250,0)] 
       h-full w-full"
                        data-border="true"
                        data-framer-name="Team Jason Davis"
                        data-highlight="true"
                        tabIndex={0}
                      >
                        <div
       ...
       rounded-[10px]"
                        ...
                        >
                          ...
                          <div className="framer-uwwp7h">
                            ...
                            >
                              <img
                                decoding="async"
                                src="https://framerusercontent.com/images/IYQFC5NsIZw60lQiKLrGR5nFdCo.png"
                                alt="Memoji Jason Davis"
                                className="block w-full h-full rounded-inherit object-center object-cover"
                              />
                            </div>
                          </div>
                  ...
                  <li className="w-[350px]">
                    <div
                      className="framer-12plkac-container w-[350px] flex-shrink-0"
                      data-framer-cursor="l8iton"
                    >
                      <div
                        className="framer-PCfLc framer-NrkXy framer-1psfxqf framer-v-u447ly border border-solid border-[1px] border-[rgb(34,34,34)] 
       bg-gradient-radial from-[rgba(80,176,250,0.1)] 
       via-[rgba(64,140,199,0.05)] to-[rgb(13,13,13)] 
       rounded-[10px] shadow-[0px_0px_2px_0.5px_rgba(112,190,250,0)] 
       h-full w-full"
                        data-border="true"
                        data-framer-name="Team Maria Wilson"
                        data-highlight="true"
                        tabIndex={0}
                      >
                        <div
       ...
       rounded-[10px]"
                        ...
                        >
                          ...
                          <div className="framer-uwwp7h">
                            ...
                            >
                              <img
                                decoding="async"
                                src="https://framerusercontent.com/images/pRCKArdqfWuQrSd9ue6FSlS2ltY.png"
                                alt="Memoji Maria Wilson"
                                className="block w-full h-full rounded-inherit object-center object-cover"
                              />
                            </div>
                          </div>
                  ...
                  <li className="w-[350px]">
                    <div
                      className="framer-g9fjht-container w-[350px] flex-shrink-0"
                      data-framer-cursor="uu36yv"
                    >
                      <div
                        className="framer-PCfLc framer-NrkXy framer-1psfxqf framer-v-346me5 border border-solid border-[1px] border-[rgb(34,34,34)] bg-gradient-radial from-[rgba(80,176,250,0.1)] via-[rgba(64,140,199,0.05)] to-[rgb(13,13,13)] rounded-[10px] shadow-[0px_0px_2px_0.5px_rgba(112,190,250,0)] h-full w-full"
                        data-border="true"
                        data-framer-name="Team William Bird"
                        data-highlight="true"
                        tabIndex={0}
                      >
                        <div
                        ...
                        >
                          ...
                          <div className="framer-uwwp7h">
                            ...
                            >
                              <img
                                decoding="async"
                                src="https://framerusercontent.com/images/9tSJR3sr04p4VvOD7dZgOobsH0.png"
                                alt="Memoji William Bird"
                                className="block w-full h-full rounded-inherit object-center object-cover"
                              />
                            </div>
                          </div>
